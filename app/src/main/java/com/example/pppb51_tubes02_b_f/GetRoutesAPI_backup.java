...
public class GetRoutesAPI_backup {
    private static final String BASE_URL = "https://devel.loconode.com/pppb/v1/routes";
    private IMultipleRequest connectFragment;
    private Context context;

    public GetRoutesAPI_backup(IMultipleRequest connectFragment, Context context){
