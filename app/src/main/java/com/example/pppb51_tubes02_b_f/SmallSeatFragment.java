...
public class SmallSeatFragment extends Fragment implements View.OnClickListener, View.OnTouchListener, ISmallSeatFragment, IConnectFragment {
    ...
    public static SmallSeatFragment newInstance(HashMap<String,String> bookInfo) {
        SmallSeatFragment fragment = new SmallSeatFragment();
